...
export function SignInForm() {
  ...
  return <form onSubmit={submit} className="flex flex-col gap-5">
    ...
    <Button type="submit" disabled={loading} className="h-12 rounded-2xl text-base font-bold">{loading ? 'Entrando...' : 'Entrar'}</Button>
